            ...
            <div class="float-end">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="{{ URL::asset('build/images/users/user2.jpg') }}"
                            alt="Header Avatar">
                ...
                <div class="navbar-brand-box">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm text-white">
                            <img src="{{ URL::asset('build/images/logo.jpg') }}" alt="" height="50" style="border-radius:150px;">
                            &nbsp; <span style="font-weight: bold;">Medical Islands</span>
                        </span>
